...
class Generated20260522224030997fef23Top2Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-22T22:41:37.833985+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][turnover_1m_10][pass_signal][HierarchicalRiskParity]',
            description='GA materialized strategy. Selector=turnover_1m_10; Signal=pass_signal; Allocation=HierarchicalRiskParity; TOTAL_SCORE=19.11475864791865.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
