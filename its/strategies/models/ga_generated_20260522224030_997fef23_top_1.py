...
from its.strategies.core.optimization import CVaRHighRisk
...
class Generated20260522224030997fef23Top1Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-22T22:41:37.818923+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][turnover_1m_10][pass_signal][CVaRHighRisk]',
            description='GA materialized strategy. Selector=turnover_1m_10; Signal=pass_signal; Allocation=CVaRHighRisk; TOTAL_SCORE=20.4925249520063.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
