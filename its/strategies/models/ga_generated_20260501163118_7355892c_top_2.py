...
class Generated202605011631187355892cTop2Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-01T16:32:58.971599+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][sector_it_telecom][TwoCandlePositiveTrendSignal][equal_weighted]',
            description='GA materialized strategy. Selector=sector_it_telecom; Signal=TwoCandlePositiveTrendSignal; Allocation=equal_weighted; TOTAL_SCORE=23.265322530902175.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
