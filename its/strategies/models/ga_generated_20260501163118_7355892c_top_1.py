...
class Generated202605011631187355892cTop1Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-01T16:32:58.962510+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][sector_energy_telecom][TwoCandlePositiveTrendSignal][CVaR]',
            description='GA materialized strategy. Selector=sector_energy_telecom; Signal=TwoCandlePositiveTrendSignal; Allocation=CVaR; TOTAL_SCORE=23.351237432713376.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
