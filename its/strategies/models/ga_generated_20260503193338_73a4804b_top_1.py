...
class Generated2026050319333873a4804bTop1Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-03T19:34:28.602846+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][sector_energy_telecom][TwoCandlePositiveTrendSignal][CVaR]',
            description='GA materialized strategy. Selector=sector_energy_telecom; Signal=TwoCandlePositiveTrendSignal; Allocation=CVaR; TOTAL_SCORE=23.5712803639557.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
