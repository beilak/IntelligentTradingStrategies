...
class GAGenerated202604282213283178fbd4Top1Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-04-28T22:13:38.765850+00:00."""
    ...
    def build(self) -> Strategy:
        return Strategy(
            ...
            description=(
                ...
                "Signal=trend_20; Allocation=inverse_volatility; "
                "TOTAL_SCORE=15.97187485966738."
            ),
            pipeline=Pipeline(
                steps=[
                    (
