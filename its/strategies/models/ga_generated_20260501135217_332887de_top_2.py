...
class Generated20260501135217332887deTop2Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-05-01T13:52:20.927440+00:00."""

    @override
    def build(self) -> Strategy:
        return Strategy(
            name='[GA][turnover_1m_10][pass_signal][equal_weighted]',
            description='GA materialized strategy. Selector=turnover_1m_10; Signal=pass_signal; Allocation=equal_weighted; TOTAL_SCORE=0.0.',
            pipeline=Pipeline(
                steps=[
                    (
                        'pre_selection',
