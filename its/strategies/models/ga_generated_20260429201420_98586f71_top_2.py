...
class GAGenerated2026042920142098586f71Top2Builder(StrategyBuilder):
    """Materialized GA strategy generated at 2026-04-29T20:14:48.692406+00:00."""
    ...
    def build(self) -> Strategy:
        return Strategy(
            ...
            description='GA materialized strategy. Selector=turnover_1m_10; Signal=trend_threshold_40; Allocation=equal_weighted; TOTAL_SCORE=15.253065052139569.',
            pipeline=Pipeline(
                steps=[
                    (
                        'ga_pre_selection',
